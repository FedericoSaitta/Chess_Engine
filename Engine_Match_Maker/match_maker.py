...
STARTING_BOARD  = [  # Switching to a 1D board representation    # Left right is +/- 1 and up and down is +/- 8
    ...
    -100, -100, 0   , 0, -100, -100, -100, -100,  # 8 to 15
      0 ,  0  ,  0  ,-100  ,  0  ,  0  ,  0  ,   0 ,  # 16 to 23
      0 ,  0  , -100,  0  ,  0  ,  0  ,  0  ,  0  ,  # 24 to 31
      0 ,  0  ,  0  ,  0  ,  100  ,  0  ,  0  ,  0  ,  # 32 to 39
      0 ,   0 ,   0 ,  0  ,  0  ,  320  ,  0  ,  0  ,  # 40 to 47
     100,  100,  100,  100,  0  ,  100,  100,  100,  # 48 to 55
     500,  320,  330,  900,    1,  330,  0  ,  500]  # 56 to 63
